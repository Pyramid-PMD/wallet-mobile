...
export default {
  ...
  // Card
  cardDefaultBg: Colors.secondaryBackground,
  cardBorderColor: Colors.secondaryBackground,
  cardBorderRadius: 2,
  ...
  //Container
  containerBgColor: Colors.primaryBackground,
  ...
  // FooterTab
  tabBarTextColor: Colors.secondaryText,
  tabBarTextSize: 11,
